...
namespace Simulator.Server.Migrations
{
    ...
    [Migration("20250923233428_AddPrefredMixersToLinePlanned")]
    partial class AddPrefredMixersToLinePlanned
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Simulator.Server.Databases.Entities.HC.BaseEquipment", b =>
                {
                    ...
                    b.Property<int>("ProccesEquipmentType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Simulator.Server.Databases.Entities.HC.MixerPlanned", b =>
                {
                    ...
                    b.Property<double>("MixerCapacityValue")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Simulator.Server.Databases.Entities.HC.MixerPlanned", b =>
                {
                    ...
                    b.HasOne("Simulator.Server.Databases.Entities.HC.BackBoneStep", "BackBoneStep")
                        .WithMany("MixerPlanneds")
                    ...
                    b.HasOne("Simulator.Server.Databases.Entities.HC.Tank", "ProducingTo")
                        .WithMany("MixerPlanneds")
                        .HasForeignKey("ProducingToId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("BackBoneStep");

                    b.Navigation("Mixer");

                    b.Navigation("ProducingTo");
