...
namespace GeminiSimulator.PlantUnits.Lines
{
    ...
    {
        Operating,           // Producción efectiva y micro-paradas de AU
        SupplyLoss,          // Problemas de entrada (WIP vacío)
        TechnicalLoss,       // Cambios de formato, lavados, averías
        PlannedLoss,         // Paradas programadas (almuerzos, reuniones)
        OrganizationalLoss   // Fuera de turno o sin programación
    }
